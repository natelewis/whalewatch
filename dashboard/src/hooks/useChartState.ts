...
export const useChartState = (initialSymbol: string, initialTimeframe: ChartTimeframe | null = null) => {
...
return;
    ...
    const transformedXScale = state.transform.k === 1 && state.transform.x === 0 
      ? xScale 
      : d3.zoomIdentity
