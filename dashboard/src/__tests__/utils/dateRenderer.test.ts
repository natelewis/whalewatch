...
describe('dateRenderer', () => {
  ...
  describe('renderDate', () => {
    ...
    it('should render long format correctly', () => {
      ...
      expect(result).toBe('1-15-2025 09:30:45');
    });
  ...
  describe('renderDateRange', () => {
    ...
    it('should render different dates with range', () => {
      ...
      expect(result).toBe('1-15-2025 - 1-16-2025');
    });
  });
  ...
  describe('military time format', () => {
    it('should always use 24-hour format for time-only', () => {
      ...
      expect(renderDate(morning, { format: 'time-only' })).toBe('04:30:00');
      expect(renderDate(evening, { format: 'time-only' })).toBe('16:30:00');
    });
    ...
    it('should always use 24-hour format for long format', () => {
      ...
      expect(renderDate(morning, { format: 'long' })).toBe('1-15-2025 04:30:00');
      expect(renderDate(evening, { format: 'long' })).toBe('1-15-2025 16:30:00');
    });
  });
});
